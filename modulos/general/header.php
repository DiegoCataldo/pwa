...
if(!isset($_SESSION["usuario2"])){ 
  ...
  header ("refresh:0; url=login.php");
    exit;
}else if($_SESSION['usuario2'] != "admin" && $_SESSION['password2'] != "ceaza/admin"){
    header ("refresh:0; url=login.php");
}
*/
?>
...
<!-- INCLUYE MOBILE DETECT -->
<?php include "modulos/general/mobileDectect.php" ; ?>
    ...
    <header>
      ...
      <nav id="slide-out" class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right side-nav" style="">
        <ul id="menu-menu-1" class="nav navbar-nav">
          ...
          <li id="menu-item-87" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-87"><a style="padding-top: 0" title="Estadísticas de uso" href="AMselecEstacion.php">Agregar Mantención</a></li>
          <li id="menu-item-87" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-87"><a style="padding-top: 0" title="Estadísticas de uso" href="http://www.cdom.cl/estadisticas-de-uso/">Estaciones</a></li>
